...
extension TextStyleHelpers on TextStyle {
  TextStyle get bold => copyWith(fontWeight: FontWeight.bold,fontFamily: "URWGeometricArabic");
  TextStyle get white => copyWith(color: Colors.white);
  TextStyle get subTitleColor => copyWith(color: LightColor.subTitleTextColor);
  TextStyle get subTitleColorCategory => copyWith(color: Color(0xff8d9293));
  TextStyle get subTitleColorpurpleCategory => copyWith(color:LightColor.skyBlue);
  TextStyle get subTitleColorpurpleRedCategory => copyWith(color:Colors.red);
...
extension PaddingHelper on Widget {
  ...
  Padding get vP4 =>
      Padding(padding: EdgeInsets.symmetric(vertical: 6), child: this);
}
